...
fun AppNavigation(
    ...
    NavHost(
        ...
        navigation(startDestination = Screen.Home.route, route = AppDestinations.HOME_SCREEN_ROUTE) {
        ...
        navigation(startDestination = Screen.Catalog.route, route = AppDestinations.CATALOG_SCREEN_ROUTE) {
        ...
        navigation(startDestination = Screen.Favorites.route, route = AppDestinations.FAVORITES_SCREEN_ROUTE) {
